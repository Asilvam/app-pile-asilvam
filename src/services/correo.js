...
module.exports = {
  enviarcorreo: async (req, opcion) => {
    ...
    Aforo<br>
    <li>En el área piscina, se permitirán sólo 4 (cuatro) personas dentro del recinto, quiere decir dentro del perímetro de la reja.</li><br>
    <li>En el área de los jardines podrán estar hasta un máximo de 10 (diez) personas, con una distancia social de 10 metros.</li><br>
    <br>
    Medidas especiales:<br>
    <li>Queda prohibido el ingreso de visitas al sector de la piscina.</li><br>
    <li>No se puede hacer uso de reposeras, ni de juguetes inflables al interior o exterior de la piscina.</li><br>
    <li>Quienes estén con sus trajes de baño, deberán utilizar en todo momento su mascarilla, y solo sacarla cuando ingresen a la piscina.</li><br>
    <li>En la entrada de la piscina, mantendremos un depósito de alcohol gel, el cual será de uso obligatorio.</li><br>
